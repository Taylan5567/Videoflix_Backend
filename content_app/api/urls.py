...
from .views import ThumbnailView, VideoListView, VideoManifestView, VideoSegmentView
...
urlpatterns = [
    ...
    path("video/<int:movie_id>/<str:resolution>/thumbnail.jpg", ThumbnailView.as_view(), name="video-thumbnail"),
]
